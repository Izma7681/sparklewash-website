  ...
  <section id="about" className="py-24">
    <div className="container mx-auto px-4 max-w-3xl text-center">
      ...
      >
        ...
        <h2 className="text-3xl md:text-4xl font-extrabold text-foreground">About SparkleWash</h2>
        <p className="mt-6 text-muted-foreground leading-relaxed text-lg">
          At SparkleWash, we are a team of dedicated laundry professionals committed to delivering spotless,
